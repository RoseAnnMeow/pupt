                                        ...
                                        <form action="profile_action.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <span class="text-danger">*</span>
                                                    <input type="text" id="phone"  class="form-control"  value="<?=$row['phone']?>" placeholder="09051234567" name="contact" required maxLength="11" minLength="11" onkeypress="isInputNumber(event)">
                                                </div>
                                                <div class="form-group col-md-4">
