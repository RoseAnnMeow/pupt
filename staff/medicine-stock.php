            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Stock of Medicines</li>
                </ol>
              </div> 
            </div> 
          </section>
                ...
                <div class="card-body">
                  <table id="stock-table" class="table table-borderless table-hover" style="width:100%">
                    <thead class="bg-light">
                      <tr>
                        <th>#</th>
                        <th class="export" width="20%">Medicines</th>
                    ...
                    <tbody>
                        <?php 
                        $i = 1;
                        $sql = "SELECT m.med_name,m.danger_level,m.unit,ms.medicines_id,ms.current_stock,ms.consumed,ms.total FROM medicines m INNER JOIN medicine_stocks ms ON m.id = ms.medicines_id";
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            ...
                            <td>
                                <form action="all_medicine_action.php" style="display: inline-block;" class="form-inline" method="post">
                                    <input type="number" name="stock" class="form-control form-control-sm col-4" min="1" required>
                                    <input type="hidden" name="med_id" value="<?=$row['medicines_id']?>">
                            ...
                            <td>
                            <a href="medicine-stock-history.php?id=<?php echo $row['medicines_id'];?>"  class="btn btn-block btn-outline-secondary btn-sm">Details</a>
