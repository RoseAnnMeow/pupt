...
?>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>Welcome to PUP Taguig<br>Dental Clinic</h1>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              <h3>Why Choose PUP Taguig Dental Clinic</h3>
              <p>
              Creating an account in our own website will give you an advantage and access to your teeth status, appointment status, you can view prescriptions, fees, and treatment performed to your teeth.
              </p>
            </div>
          </div>
    ...
    <section id="testimonials" class="testimonials">
      <div class="container">
        <div class="section-title">
            <h2>What People Say About PUP Taguig Dental Clinic</h2>
            <p>Our satisfied clients share their experience at PUP Taguig Dental Clinic.</p>
          </div>
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "104589835453571");
