...
function sendEmail($pdf,$patient_name,$patient_lname,$patient_email,$patient_date,$patient_time,$patient_phone,$treatment,$date_submission)
{
    ...
    if(isset($_POST['update_appointment'])){
        ...
        $fulldata = "SELECT a.*, CONCAT(p.fname,' ',p.lname) AS pname,p.lname,p.phone,p.email,a.created_at,a.starttime FROM tblappointment a INNER JOIN tblpatient p ON p.id ='$patient_id' WHERE a.id='$id'";
