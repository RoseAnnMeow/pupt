<?php
    ...
    if(isset($_POST['insertdata'])){
        $services = '';
        $patient_name = $_SESSION['auth_user']['user_fullName'];
        ...
        $sql = "INSERT INTO tblappointment (patient_id,patient_name,doc_id,schedule,sched_id,starttime,endtime,reason,schedtype,status,created_at)
        VALUES ('$patient_id','$patient_name','$doctor_id','$schedDate','$sched_id','$schedStart','$schedEnd','$preferredServices','$schedtype','$status','$date_submitted')";
        $query_run = mysqli_query($conn,$sql);
