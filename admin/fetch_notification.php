<?php
    ...
    if(isset($_POST["view"])){
        ...
        $query=mysqli_query($conn,"SELECT CONCAT(p.fname,' ',p.lname) AS pname,p.image,n.subject,n.created_at FROM notification n INNER JOIN tblpatient p ON n.patient_id = p.id WHERE n.type='0' ORDER BY n.id desc limit 5");
        $output = '';
        ...
        $query1=mysqli_query($conn,"select * from notification where seen_status='0' AND type='0'");
