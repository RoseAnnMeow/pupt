              ...
              <div class="row d-flex justify-content-start">
                  <div class="col-md-9">
                    <?php 
                      ...
                      {
                    ?>
                      <h4 class="text-primary text-left top_title">PUP Taguig Dental Clinic  
                      </h4>
                ...
                {
                  $user_id = $_GET['id'];
                  $user = "SELECT pres.*, CONCAT(p.fname,' ',p.lname) AS pname, p.gender, p.address, pres.dose, pres.duration, d.name,pres.advice,m.med_name,
                  ...
                  INNER JOIN medicines m ON m.id = pres.medicine
