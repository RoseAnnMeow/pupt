                                ...
                                <div class="card card-primary card-outline">
                                    ...
                                    <div class="card-body box-profile">
                                        <div class="text-center">
                                            ...
                                            src="../upload/doctors/<?=$user['image']?>"alt="User profile picture">
                                        </div>
                                            ...
                                            <div class="tab-pane fade" id="prescription" role="tabpanel" aria-labelledby="prescription-tab">
                                                <table id="prescriptiontable" class="table table-hover table-borderless" style="width:100%;">
                                                    ...
                                                    if(isset($_GET['id']))
                                                    {
                                                        $i = 1;
                                                        $user_id = $_GET['id'];
                                                        $user = "SELECT CONCAT(pat.lname,', ',pat.fname) as pname,pre.date,m.med_name,pre.advice,pre.dose,pre.duration 
                                                        FROM prescription pre 
                                                        INNER JOIN tblpatient pat 
                                                        INNER JOIN medicines m ON m.id = pre.medicine
