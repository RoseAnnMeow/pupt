            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <span class="text-danger">*</span>
                  <input type="text" class="form-control" placeholder="09051234567" name="phone" required maxLength="11" minLength="11" onkeypress="isInputNumber(event)">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <span class="text-danger">*</span>
                  <input type="password" id="password" name="password" class="form-control" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$" 
                  title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters and one special character" required>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Contact Number</label>
                  <span class="text-danger">*</span>
                  <input type="text" id="edit_phone"  class="form-control" placeholder="09051234567" name="phone" required maxLength="11" minLength="11" onkeypress="isInputNumber(event)">
                </div>
              </div>
              <div class="col-sm-6 auto">
                <div class="form-group">
