                                                            ...
                                                            <div class="tab-pane fade" id="prescription" role="tabpanel" aria-labelledby="prescription-tab">
                                                                <table id="prescriptiontable" class="table table-hover table-borderless" style="width:100%;">
                                                                    ...
                                                                    if(isset($_GET['id']))
                                                                    {
                                                                        $i = 1;
                                                                        $user_id = $_GET['id'];
                                                                        $user = "SELECT p.date,m.med_name,p.advice,p.dose,p.duration FROM prescription p JOIN medicines m ON p.medicine = m.id WHERE patient_id='$user_id'";
                                            ...
                                            <div class="col-md-12">
                                                <table id="treatmenttable" class="table table-hover table-borderless" style="width:100%;">
                                                    ...
                                                    if(isset($_GET['id']))
                                                    {
                                                        $i = 1;
                                                        $user_id = $_GET['id'];
                                                        $sql = "SELECT CONCAT(p.fname,'',p.lname) as pname,t.id,t.teeth,t.complaint,t.treatment,t.fees,t.remarks,s.day FROM treatment t INNER JOIN tblpatient p ON t.patient_id = p.id INNER JOIN schedule s ON s.id=t.visit WHERE t.patient_id='$user_id'";
