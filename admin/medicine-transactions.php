    ...
    <div class="content-wrapper">
        <div class="content-header">
            <section class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Transaction of Medicines</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">Transaction of Medicines</li>
                        </ol>
                    </div> 
                </div> 
            </section>
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <table id="transact_table" class="table table-borderless table-hover" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <th class="export">Medicine Name</th>
                                ...
                                <tbody>
                                    <?php 
                                    $sql = "SELECT m.med_name,mt.created_at,mt.user,mt.stock FROM medicines_transactions mt INNER JOIN medicines m ON mt.medicines_id = m.id ORDER BY mt.id DESC";
